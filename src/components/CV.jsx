      ...
      <div className="w-full container mx-auto px-4">
        ...
        <div className="w-full bg-primary-light rounded-xl shadow-lg p-8 card-hover">
          ...
          <div className="flex justify-center space-x-4">
            <a href="https://drive.google.com/file/d/1qfThV0tZq5HU-5BWD3nr2z51bsgDQDnD/view?usp=sharing" target="_blank" rel='noopener noreferrer' className="inline-flex items-center bg-secondary hover:bg-tertiary text-primary px-8 py-4 rounded-lg transition-all duration-300" download>
              <i className="fas fa-download mr-2"></i> Download CV in English
            </a>
            <a href="https://drive.google.com/file/d/1fkyr_ubjaM_8W4hvvqBzlhVl6UBT0gGR/view?usp=sharing" target="_blank" rel='noopener noreferrer' className="inline-flex items-center bg-secondary hover:bg-tertiary text-primary px-8 py-4 rounded-lg transition-all duration-300" download>
