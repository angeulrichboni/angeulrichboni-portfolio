        ...
        <div className="w-full grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          <div className="text-center">
            <div className="relative inline-block flex justify-center items-center">
              <img src={`https://res.cloudinary.com/ddivqszbt/image/upload/v1746353953/Me_d48ibg.jpg`} alt="Ange BONI" className="w-64 h-64 rounded-lg object-cover ring-4 ring-secondary ring-opacity-50" />
